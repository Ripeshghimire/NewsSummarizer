...
text = '''T continues its reign of success with the recent World Tour preview screenings of 'To the Hashira Training' captivating audiences worldwide. Opening to overwhelming enthusiasm and packed theatres, the event proved to be a significant milestone in the franchise's journey.
...
As fans eagerly await the premiere of the Hashira Training Arc anime in spring, antihe Demon Slayer: Kimetsu no Yaiba franchisecipation for what lies ahead continues to mount. With the franchise's unwavering popularity and a dedicated fanbase spanning the globe, the future looks brighter than ever for Demon Slayer: Kimetsu no Yaiba.'''
print(pipe(text))